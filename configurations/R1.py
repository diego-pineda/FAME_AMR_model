...
mRho  = 6100.  # [kg/m^3]... Written by Diego Pineda: This is an assumed MCM density to calculate porosity of bed
mK    = 6  # [W/(m K)]...Written by DP: this is an assumed thermal conductivity of the MCM
