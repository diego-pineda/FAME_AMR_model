...
# Specifc Heat
cpdat_c   = np.loadtxt('sourcefiles/mat/ssi5/M5_cp_Si_34_IGM_Q20_c.txt')
cpdat_h   = np.loadtxt('sourcefiles/mat/ssi5/M5_cp_Si_34_IGM_Q20_h.txt')
# Magnetization
magdata_c = np.loadtxt('sourcefiles/mat/ssi5/M5_Mag_Si_34_IGM_Q20_c.txt')
magdata_h = np.loadtxt('sourcefiles/mat/ssi5/M5_Mag_Si_34_IGM_Q20_h.txt')
# Entropy
datstot_c = np.loadtxt('sourcefiles/mat/ssi5/M5_S_Si_34_IGM_Q20_c.txt')
datstot_h = np.loadtxt('sourcefiles/mat/ssi5/M5_S_Si_34_IGM_Q20_h.txt')
